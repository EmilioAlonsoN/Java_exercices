...
public class Television {
	...
	public Television(String brand, int volume, DisplayType displayType) {
		this(brand, volume);
		System.out.println("Constructor with three arguments String + int + displayType.");
	...
	public String toString() {
		...
		return "Television brand is: " + getBrand() + " with volume: " + msg + " with displayType: " + displayType;
	}
